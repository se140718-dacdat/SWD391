...
const CreatePost: React.FC = props => {
    ...
    const uploadPost = async () => {
        console.log(post);
        try {
            const res = await axios.post("http://nguyenxuanthuan-001-site1.htempurl.com/api/posts", post, {
                headers: {
            ...
            console.log(error);
            alert("Create post fail! please try again")
        }
    }
    ...
    const convertCurrencyToInt = (currency: string) => {
                    ...
                    <div className="post-wrap">
                        ...
                        <div className="post-data">
                            ...
                            <div className="input inline-block">
                                ...
                                <input type="text" className="input-value" onChange={(e) => {
                                    post.price = convertCurrencyToInt(e.target.value);
                            ...
                            <div className="btn-wrap mt-250">
                                <button className="btn-preview-edit" onClick={() => {
                                    (preview) == "Preview" ? isPreview("Edit post") : isPreview("Preview");
                                }}>{preview}</button>
                        ...
                        <div className="border">
                            <div className="product-type">
                                ...
                                <div className="product-summary">
                                    ...
                                    <div className="product-price">{`${currency} đ`}</div>
